...
<body onload="start();">
    <section class="page">
        <section class="fall_risk-interface">
            <table class="center">
                <tr>
                    <td colspan="3">
                        <div id="Instructions" class="fall_risk-interface"> This block will contain a welcome message and instructions to operate the turtlebot</div>
                    </td>
                </tr>

                <tr>
                    <td colspan="3">
                        <div id="mjpeg_canvas" class="main-widget"></div>
                    </td>
                </tr>
                <tr>
                    <td width="33%">
